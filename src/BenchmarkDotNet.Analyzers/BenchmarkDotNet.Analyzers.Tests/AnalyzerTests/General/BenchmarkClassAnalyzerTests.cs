...
public class BenchmarkClassAnalyzerTests
{
    ...
    public class ClassMustBePublic : AnalyzerTestFixture<BenchmarkClassAnalyzer>
    {
        ...
        public static TheoryData<string> NonPublicClassAccessModifiersExceptFileTheoryData => new(new NonPublicClassAccessModifiersTheoryData().Where(tdr => tdr.Data != "file "));
    }
