...
public class ParamsAttributeAnalyzerTests
{
    public class General : AnalyzerTestFixture<ParamsAttributeAnalyzer>
    {
        ...
        public async Task A_field_or_property_not_annotated_with_the_params_attribute_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
    ...
    public class MustHaveValues : AnalyzerTestFixture<ParamsAttributeAnalyzer>
    {
        ...
        [Theory, CombinatorialData]
        public async Task Providing_one_or_more_values_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_array_with_a_rank_specifier_size_higher_than_zero_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                                       [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
        ...
        [Theory, CombinatorialData]
        public async Task Providing_no_values_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                        [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
        ...
        public static TheoryData<string> DummyAttributeUsage => DummyAttributeUsageTheoryData;
        ...
        private static ReadOnlyCollection<string> ScalarValues => Enumerable.Range(1, 3)
                                                                            ...
                                                                            .ToList()
                                                                            .AsReadOnly();
        public static TheoryData<string> ScalarValuesContainerAttributeArgument => ScalarValuesContainerAttributeArgumentTheoryData();

        public static TheoryData<string> EmptyParamsAttributeUsagesWithLocationMarker()
        {
    ...
    public class UnexpectedValueType : AnalyzerTestFixture<ParamsAttributeAnalyzer>
    {
        ...
        [Theory, CombinatorialData]
        public async Task Providing_a_field_or_property_with_an_unknown_type_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                           [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                                           [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
            var testCode = /* lang=c#-test */ $$"""
        ...
        [Theory, CombinatorialData]
        public async Task Providing_convertible_value_types_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                          [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                          [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
            var testCode = /* lang=c#-test */ $$"""
        ...
        [Theory, CombinatorialData]
        public async Task Providing_both_expected_and_unexpected_value_types_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                       [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                                       [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
            const string expectedFieldOrPropertyType = "int";
            const string valueWithUnexpectedType = """
                                                   "test1"
                                                   """;
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_unknown_value_type_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                    [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                    [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
            const string expectedFieldOrPropertyType = "int";
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_unexpected_or_not_convertible_value_type_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                          [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                                          [CombinatorialMemberData(nameof(NotConvertibleValuesAndTypes))] string[] valueAndType,
                                                                                                          [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_unexpected_array_value_type_to_params_attribute_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                                 [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_empty_array_value_when_type_of_attribute_target_is_not_object_array_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                                                         [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
        ...
        [Theory, CombinatorialData]
        public async Task Providing_an_empty_array_value_when_type_of_attribute_target_is_object_array_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                                                                     [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                                                                     [CombinatorialMemberData(nameof(EmptyValuesAttributeArgument))] string emptyValuesAttributeArgument)
        {
            var testCode = /* lang=c#-test */ $$"""
        ...
        public static TheoryData<string> EmptyValuesAttributeArgument()
        {
            return new TheoryData<string>(GenerateData());
    ...
    public class UnnecessarySingleValuePassedToAttribute : AnalyzerTestFixture<ParamsAttributeAnalyzer>
    {
        ...
        [Theory, CombinatorialData]
        public async Task Providing_two_or_more_values_should_not_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                     [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
                                                                                     [CombinatorialMemberData(nameof(ScalarValuesListLength))] int scalarValuesListLength,
                                                                                     [CombinatorialMemberData(nameof(ScalarValuesContainerAttributeArgument))] string scalarValuesContainerAttributeArgument)
        {
        ...
        [Theory, CombinatorialData]
        public async Task Providing_only_a_single_value_should_trigger_diagnostic([CombinatorialClassData(typeof(FieldOrPropertyDeclarationTheoryData))] string fieldOrPropertyDeclaration,
                                                                                  [CombinatorialMemberData(nameof(DummyAttributeUsage))] string dummyAttributeUsage,
        ...
        public static TheoryData<string> ScalarValuesContainerAttributeArgumentWithLocationMarker()
        {
            return new TheoryData<string>(GenerateData());
