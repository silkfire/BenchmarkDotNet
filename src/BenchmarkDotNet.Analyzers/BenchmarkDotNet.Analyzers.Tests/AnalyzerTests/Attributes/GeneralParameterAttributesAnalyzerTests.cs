...
using DuplicateAttributeUsages = (string CurrentUniqueAttributeUsage, int CurrentUniqueAttributeUsagePosition, int[] Counts);
...
public class GeneralParameterAttributesAnalyzerTests
{
    public class MutuallyExclusiveOnField : AnalyzerTestFixture<GeneralParameterAttributesAnalyzer>
    {
        ...
        public async Task A_field_annotated_with_the_same_duplicate_parameter_attribute_should_not_trigger_diagnostic(string currentUniqueAttributeUsage, int currentUniqueAttributeUsagePosition, int[] counts)
        {
            ...
            var uniqueParameterAttributeUsages = UniqueParameterAttributeUsages.ToEnumerable()
                                                                               .ToList()
                                                                               .AsReadOnly();
        ...
        public static TheoryData<string> UniqueParameterAttributeUsages => new(UniqueParameterAttributesTheoryData.Select(tdr => tdr.Data.Item2));
    ...
    public class FieldMustBePublic : AnalyzerTestFixture<GeneralParameterAttributesAnalyzer>
    {
        ...
        public async Task A_nonpublic_field_annotated_with_the_same_duplicate_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateSameParameterAttributeUsages))] DuplicateAttributeUsages duplicateSameParameterAttributeUsages,
                                                                                                                                [CombinatorialClassData(typeof(NonPublicClassMemberAccessModifiersTheoryData))] string classMemberAccessModifier)
        {
        ...
        [Theory, CombinatorialData]
        public async Task A_nonpublic_field_annotated_with_more_than_one_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateParameterAttributeUsageCounts))] int[] duplicateAttributeUsageCounts,
                                                                                                                           [CombinatorialClassData(typeof(NonPublicClassMemberAccessModifiersTheoryData))] string classMemberAccessModifier)
        {
            var duplicateAttributeUsages = new List<string>(duplicateAttributeUsageCounts.Sum());
        ...
        public static IEnumerable<(string AttributeName, string AttributeUsage)> UniqueParameterAttributes => UniqueParameterAttributesTheoryData.Select(tdr => (tdr.Data.Item1, tdr.Data.Item2));

        public static IEnumerable<DuplicateAttributeUsages> DuplicateSameParameterAttributeUsages => DuplicateSameAttributeUsagesTheoryData.Select(tdr => tdr.Data);
    ...
    public class PropertyMustBePublic : AnalyzerTestFixture<GeneralParameterAttributesAnalyzer>
    {
        ...
        [Theory, CombinatorialData]
        public async Task A_nonpublic_property_annotated_with_the_same_duplicate_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateSameParameterAttributeUsages))] DuplicateAttributeUsages duplicateSameParameterAttributeUsages,
                                                                                                                                   [CombinatorialClassData(typeof(NonPublicClassMemberAccessModifiersTheoryData))] string classMemberAccessModifier)
        {
            var duplicateAttributeUsages = new List<string>(1 + duplicateSameParameterAttributeUsages.Counts.Sum());
        ...
        [Theory, CombinatorialData]
        public async Task A_nonpublic_property_annotated_with_more_than_one_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateParameterAttributeUsageCounts))] int[] duplicateAttributeUsageCounts,
                                                                                                                              [CombinatorialClassData(typeof(NonPublicClassMemberAccessModifiersTheoryData))] string classMemberAccessModifier)
        {
            var duplicateAttributeUsages = new List<string>(duplicateAttributeUsageCounts.Sum());
    ...
    public class PropertyMustHavePublicSetter : AnalyzerTestFixture<GeneralParameterAttributesAnalyzer>
    {
        ...
        [Theory]
        [MemberData(nameof(NonPublicPropertySetters))]
        ...
        [Theory, CombinatorialData]
        public async Task A_property_with_a_nonpublic_setter_annotated_with_the_same_duplicate_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateSameParameterAttributeUsagesEnumerable))] DuplicateAttributeUsages duplicateSameParameterAttributeUsages,
        ...
        [Theory, CombinatorialData]
        public async Task A_property_with_a_nonpublic_setter_annotated_with_more_than_one_parameter_attribute_should_not_trigger_diagnostic([CombinatorialMemberData(nameof(DuplicateParameterAttributeUsageCounts))] int[] duplicateAttributeUsageCounts,
                                                                                                                                            [CombinatorialMemberData(nameof(NonPublicPropertySetters))] string nonPublicPropertySetter)
        {
            var duplicateAttributeUsages = new List<string>(duplicateAttributeUsageCounts.Sum());
        ...
        public static IEnumerable<DuplicateAttributeUsages> DuplicateSameParameterAttributeUsagesEnumerable => DuplicateSameAttributeUsagesTheoryData.Select(tdr => tdr.Data);

        public static TheoryData<int[]> DuplicateParameterAttributeUsageCounts => DuplicateAttributeUsageCountsTheoryData;

        public static TheoryData<string> NonPublicPropertySetters() => new(new NonPublicPropertySetterAccessModifiersTheoryData().ToEnumerable()
                                                                                                                                 .Select(m => $$"""{ get; {{m}} set; }"""))
                                                                       {
                                                                           "{ get; }",
                                                                           "=> 0;"
    ...
    public static TheoryData<string, int, int[]> DuplicateSameAttributeUsagesTheoryData => new(GenerateDuplicateSameAttributeUsageCombinations(UniqueParameterAttributesTheoryData));
    ...
    private static ReadOnlyCollection<DuplicateAttributeUsages> GenerateDuplicateSameAttributeUsageCombinations(TheoryData<string, string> uniqueAttributeUsages)
    {
        var uniqueAttributeUsagesList = uniqueAttributeUsages.Select(tdr => tdr.Data.Item2)
                                                             .ToList()
                                                             .AsReadOnly();

        var finalCombinationsList = new List<DuplicateAttributeUsages>();
